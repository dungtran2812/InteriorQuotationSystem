...
import { axiosClient } from "../../../api/axiosClients";
  ...
  export default function ModalCreateRawMaterial({
    open,
    setOpen,
    fetchRawMaterials,
    setIsLoading
              ...
              onSubmit={async (values) => {
                try {
                  ...
                  const response = await axiosClient.post(
                    `/rawMaterial/createProduct?name=${values.name}&description=${values.description}&type=${values.type}&pricePerM2=${values.pricePerM2}`,
                    submitValues,
                    {
                      headers: {
                  ...
                  console.error("Error create Raw Material:", error);
