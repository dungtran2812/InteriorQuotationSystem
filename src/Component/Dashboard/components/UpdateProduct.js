            ...
            onSubmit={async (values) => {
              try {
                ...
                const response = await axiosClient.put(
                  `/product/updateProduct?productId=${product.id}&name=${values.name}&description=${values.description}&type=${values.type}&width=${values.width}&height=${values.height}&length=${values.length}&price=${values.price}`,
                  submitValues,
                  {
                    headers: {
