  ...
  return (
    ...
    <div>
      ...
      <Grid item xs={12} sm={6} md={4}>
        <img className="responsive-image" src='https://www.lanha.vn/wp-content/uploads/2023/10/3649ac5b68fbbca5e5ea7.jpg'/>
      </Grid>
      <Grid item xs={12} sm={6} md={4}>
      <img className="responsive-image" src='https://www.lanha.vn/wp-content/uploads/2023/10/3649ac5b68fbbca5e5ea7.jpg'/>
      </Grid>
      ...
      <section id="Living">
        ...
        <Grid container spacing={2}>
      <Grid item xs={12} sm={6} md={4}>
        <img className="responsive-image" src='https://noithatanmoc.vn/wp-content/uploads/2024/02/Thiet-ke-noi-that-chung-cu-Diamond-Alnata-0.jpg'/>
      </Grid>
      <Grid item xs={12} sm={6} md={4}>
      <img className="responsive-image" src='https://noithatanmoc.vn/wp-content/uploads/2024/02/Thiet-ke-noi-that-chung-cu-Diamond-Alnata-0.jpg'/>
      </Grid>
      ...
      <section id="Bed">
        ...
        <Grid container spacing={2}>
      <Grid item xs={12} sm={6} md={4}>
        <img className="responsive-image" src='https://noithatanmoc.vn/wp-content/uploads/2024/02/Thiet-ke-noi-that-chung-cu-Diamond-Alnata-8.jpg'/>
      </Grid>
      <Grid item xs={12} sm={6} md={4}>
      <img className="responsive-image" src='https://noithatanmoc.vn/wp-content/uploads/2024/02/Thiet-ke-noi-that-chung-cu-Diamond-Alnata-8.jpg'/>
      </Grid>
