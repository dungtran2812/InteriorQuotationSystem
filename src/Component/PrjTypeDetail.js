...
export default function PrjTypeDetail() {
  return (
    ...
    <div className='container'>
        ...
        <strong>Báo giá hoàn thiện phần thô chung cư</strong>
        ...
        <p>Dịch vụ này bao gồm việc tạo ra không gian sống tiện nghi, thoải mái và thẩm mỹ bằng cách lắp đặt và hoàn thiện các thành phần nội thất từ phòng khách, phòng ngủ, nhà bếp đến nhà tắm.</p>
        <strong>Báo giá nội thất căn hộ 1 phòng ngủ</strong>
        <p>Báo giá chi tiết cho việc hoàn thiện nội thất cho căn hộ 1 phòng ngủ của quý vị. Dịch vụ này nhằm mục đích tạo ra một không gian sống thoải mái, tiện nghi và thẩm mỹ cho gia đình bạn.</p>
